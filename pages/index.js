...
const LEGEND_COLORS = {
  ...
  'garen': ['#F1C40F', '#E67E22'],
  'yasuo': ['#27AE60', '#8E44AD'],
  'darius': ['#F1C40F', '#E74C3C'],
  'teemo': ['#8E44AD', '#2E86C1'],
  'viktor': ['#F1C40F', '#2E86C1'],
  'leona': ['#F1C40F', '#27AE60'],
  'miss-fortune': ['#8E44AD', '#E67E22'],
  'volibear': ['#E67E22', '#E74C3C'],
  'maitre-yi': ['#27AE60', '#E67E22'],
  'jinx': ['#E74C3C', '#8E44AD'],
  'ahri': ['#27AE60', '#2E86C1'],
  'lee-sin': ['#E67E22', '#27AE60'],
  'annie': ['#8E44AD', '#E74C3C'],
  'kaisa': ['#2E86C1', '#E74C3C'],
  'sett': ['#F1C40F', '#E67E22'],
  'azir': ['#F1C40F', '#27AE60'],
  'sivir': ['#E67E22', '#8E44AD'],
  'irelia': ['#27AE60', '#8E44AD'],
  'renata': ['#2E86C1', '#F1C40F'],
  'ezreal': ['#2E86C1', '#8E44AD'],
  'rumble': ['#2E86C1', '#E74C3C'],
  'fiora': ['#E67E22', '#F1C40F'],
  'ornn': ['#2E86C1', '#27AE60'],
  'lucian': ['#E67E22', '#E74C3C'],
  'draven': ['#E74C3C', '#8E44AD'],
  'reksai': ['#F1C40F', '#E74C3C'],
  'jax': ['#E67E22', '#27AE60'],
  'lillia': ['#2E86C1', '#27AE60'],
  'khazix': ['#E67E22', '#8E44AD'],
  'diana': ['#2E86C1', '#8E44AD'],
  'ivern': ['#F1C40F', '#27AE60'],
  ...
  'jhin': ['#2E86C1', '#E74C3C'],
  'vi': ['#F1C40F', '#E74C3C'],
  'rengar': ['#E67E22', '#E74C3C'],
  'pyke': ['#8E44AD', '#E74C3C'],
  'maitre-yi-unleashed': ['#27AE60', '#E67E22'],
  'poppy': ['#F1C40F', '#E67E22'],
};
